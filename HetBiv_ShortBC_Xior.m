function [BCF]=HetBiv_ShortBC_Xior(ts1,ts2,ndpr,howfar,figflag)
% function [BCF]=HetBiv_ShortBC_Xior(ts1,ts2,ndpr,howfar)
...
BCF_correction=(1./ndpr).*corr(a,b); %only one quarter of the dude!
